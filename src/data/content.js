...
export const FOOTER_LINKS = {
  ...
  Training: [
    ...
    { name: "Corporate Training", link: "/training#corporate" },
    { name: "Bootcamps", link: "/training#bootcamps" },
    { name: "Workshops & Seminars", link: "/training#workshops" },
    { name: "Curriculum Design", link: "/training#curriculum" },
  ],
  Company: [
